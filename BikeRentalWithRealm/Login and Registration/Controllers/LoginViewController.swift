...
//    func returnImage(image: UIImageView) -> UIImage{
//        let backImage = UIImageView()
//        backImage.image = UIImage(named: "bg1")
...
//
    ...
    override func viewDidLayoutSubviews() {
        ...
        loginButton.frame = CGRect(x: (view.bounds.width / 2) - (frameWidth / 2),y: passwordField.bottom + 150, width: frameWidth, height: 52)
